...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-LB73fzoK.mjs");
...
var manifest = {
	"638f6bb93bb6b4a9c56ebbed88d1f11fd81f89d1c7abcf71ec1e01741cf2de3a": {
		functionName: "fetchLocationIntel_createServerFn_handler",
		importer: () => import("./location-intel-DOcptyCd.mjs")
	},
	"84c04695162596c46ea9c6ecd9cba7dd5d05f049f3f45cceb823e5f371826118": {
		functionName: "generateFeasibilityStudy_createServerFn_handler",
		importer: () => import("./generate-study-CeeBRUgR.mjs")
	},
	"d7c40254e0ad028fcf807f0e541e7355bf66f50db8e59bb94015678be3e2c9cf": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B7iB7LG4.mjs").then((n) => n.t),
